...
<p className="my-8">`@jdion/cast` is a lightweight and intuitive API designed to simplify communication with Chromecast devices directly from your web browser.</p>
